...
class SpirographPointProvider implements PointProvider {
  ...
  // After calling init, call this function to set the rads equal to the closest point along
  // the new spirograph to the previous point.
  public void setRadsToBestMatch() {
    if (lastPoint != null) {
